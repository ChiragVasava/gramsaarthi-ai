...
| **`GramSaarthi_AI_Hackathon_Presentation.pptx`** | **Official Slide Deck**: 12-slide master PowerPoint presentation formatted with modern rural typography, diagrams, and solution highlights. | Live Hackathon Pitch, Evaluators, Organizers | Pitch Deck, Business Case, System Demo, Architecture |
| **`GramSaarthi_AI_Hackathon_Presentation.pdf`** | **Pitch Deck PDF**: High-resolution, self-contained PDF export of the presentation slides for offline review and portal uploads. | Judges, Portal Uploads, Offline Review | Universal Presentation Document |
